package com.example.instant_project.util
...
/***
 * converting the Retrofit Call object to a LiveData object
 * First Wrap around by GenericApiResponse, and then wrap it in LiveData
 */
